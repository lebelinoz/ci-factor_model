...
$$r_t = \alpha + \beta_B r_{B,t} + \beta_F r_{F,t} + \theta_t$$
where $B$ is the benchmark equity index and the $F$ is another factor.  I've tried changes in _Brent Oil_, various currencies and the all US Dollar basket index (ticker _DXY-IFUS_ in FactSet).

***Results are on the next page, but are better viewed in Excel***

## Other shocks' results
```{r, results='asis'}
