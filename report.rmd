...
I computed this model for each stock in the global portfolio.  Then I shock the 10Y U.S. Treasury Yield by +100 bps and calculate the estimated return of your portfolio based on
...
I also computed the model over the same timeframe which Barra did for us a couple of months ago (October 2013 to Octoboer 2016).  I find:
